...
class DatabaseController extends Controller
{
    ...
    public function our_backup_database(){
        if(count(Auth::user()->superadmins) > 0) { 
            ...
            $tables             = array("migrations","users","password_resets","failed_jobs","personal_access_tokens","super_admins","semesters","majors","students","modules","courses","moderators","marks"); //here your tables...
